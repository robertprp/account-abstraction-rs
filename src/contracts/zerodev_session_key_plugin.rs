...
pub mod zero_dev_session_key_plugin {
    ...
    pub static ZERODEVSESSIONKEYPLUGIN_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl ::ethers::core::abi::AbiDecode for ZeroDevSessionKeyPluginCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <ParseDataAndSignatureCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::ParseDataAndSignature(decoded));
            }
            if let Ok(decoded)
                = <RevokeSessionKeyCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::RevokeSessionKey(decoded));
            }
            if let Ok(decoded)
                = <RevokedCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Revoked(decoded));
            }
            if let Ok(decoded)
                = <ValidatePluginDataCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::core::convert::From<ParseDataAndSignatureCall>
    for ZeroDevSessionKeyPluginCalls {
